    ...
    return (<div className={ classes.actionsContainer }>
      ...
      <div className={classes.tradeContainer}>
        <div className={ classes.balances }>
          <Typography variant='h4' onClick={ () => { this.setRedeemAmount(100) } }  className={ classes.value } noWrap>{ asset.pricePerFullShare ? (Math.floor(asset.pricePerFullShare*10000)/10000).toFixed(4) : '0.0000' } { asset.poolSymbol } ({ (asset.pooledBalance ? (Math.floor(asset.pooledBalance*10000)/10000).toFixed(4) : '0.0000') } { asset.symbol }) </Typography>
        </div>
        <TextField
          fullWidth
          className={ classes.actionInput }
